    <div class="mb-4 w-full mx-auto bg-slate-800 p-4 rounded-md">
        <div class="w-full">
    ...
    <div class="rounded-md shadow p-4 mb-4 w-full mx-auto bg-gray-800 ">
        <div class="flex items-center justify-between mb-3">
            <h2 class="text-lg font-semibold text-gray-200">Semua Fitur</h2>
        ...
        <!-- GRID MENU -->
        <div class="flex flex-wrap justify-around sm:justify-start gap-4 text-center w-full">

            <!-- ITEM -->
            <div class="flex flex-col items-center gap-1 ">
                <a href="">
                    <div class="w-14 h-14 p-[1px] rounded-md flex items-center justify-center bg-gradient-to-r from-gray-800 to-orange-500">
                ...
                <span class="text-xs text-gray-200">Dasboard</span>
            </div>

            <!-- ITEM -->
            <div class="flex flex-col items-center gap-1 ">
                <a href="">
                    <div class="w-14 h-14 p-[1px] rounded-md flex items-center justify-center bg-gradient-to-r from-gray-800 to-blue-500">
                        <div class="w-full h-full flex items-center justify-center rounded-md bg-gray-800">
                ...
                <span class="text-xs text-gray-200">Barang</span>
            </div>
            ...
            <div class="flex flex-col items-center gap-1 ">
                ...
                <span class="text-xs text-gray-200">Jurusan</span>
            </div>
        </div>
    </div>