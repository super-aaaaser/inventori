...
<section class="mb-4 w-full mx-auto">
    <div class="rounded-md p-4 bg-gradient-to-r from-white to-gray-50 shadow-sm">
        <div class="flex items-center justify-between mb-3">
            <h2 class="text-lg font-semibold text-gray-700">📦 Data Jurusan</h2>
            <a href="/inventori/jurusan/add" class="px-3 py-1.5 bg-indigo-600 text-white rounded-sm text-sm shadow hover:bg-indigo-700">
                + Tambah
            </a>
        </div>
        ...
        <div class="mb-3">
            <input type="text" placeholder="Cari Jurusan..."
                class="w-full rounded-sm py-2 px-3 border border-gray-200 text-sm focus:border-indigo-500 focus:ring-indigo-500" />
        </div>
            ...
            <table class="w-full text-sm text-left text-gray-600">
                <thead class="bg-indigo-600 text-white text-xs uppercase">
                    <tr>
                        ...
                        <th class="px-3 py-2">Nama Jurusan</th>
                ...
                <tbody class="divide-y">
                    <?php while ($row = mysqli_fetch_assoc($result)) : ?>
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-3 py-2"><?php echo $row['nama_jurusan']; ?></td>
