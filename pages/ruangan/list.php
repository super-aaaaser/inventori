<?php
$query = "SELECT nama_ruangan, kode_jurusan FROM ruangan INNER JOIN jurusan ON ruangan.jurusan_id = jurusan.id_jurusan ORDER BY id_ruangan DESC";
...
<section class="w-full mx-auto">
    <div class="rounded-md w-full p-4 bg-gradient-to-r from-white to-gray-50 shadow-sm">
        <div class="flex items-center justify-between mb-3">
            <h2 class="text-lg font-semibold text-gray-700">📦 Data User</h2>
            <a href="/inventori/ruangan/add" class="px-3 py-1.5 bg-indigo-600 text-white rounded-md text-sm shadow hover:bg-indigo-700">
                + Tambah
            </a>
        </div>
        ...
        <div class="mb-3">
            <input type="text" placeholder="Cari barang..."
                class="w-full rounded-md p-2 border-gray-300 text-sm focus:border-indigo-500 focus:ring-indigo-500" />
        </div>
            ...
            <table class="w-full text-sm text-left text-gray-600">
                <thead class="bg-indigo-600 text-white text-xs uppercase">
                    <tr>
                        ...
                        <th class="px-3 py-2">Nama Ruangan</th>
